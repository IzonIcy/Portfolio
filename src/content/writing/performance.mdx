...
image: '/static/images/performance/mozart.webp'
---
...
<img
  alt="The Bell Curve"
  src="/static/images/performance/shapes.webp"

className="rounded-lg"
/>

- do not overthink it, just go with the flow - do not overthink it, just go with
  the flow - do not overthink it, just go with the flow
