...
the entire system is optimized for the wrong thing. universities optimize for credentials. duolingo optimizes for engagement metrics. anki optimizes for card count. none of them optimize for _actually making you smarter_.

## the 2-sigma problem

bloom showed in 1984 that 1-on-1 tutoring produces 2 standard deviations of improvement. read that again. that's taking an average student and making them better than 98% of peers. not through magic, not through genetics - just through having a tutor who pays attention to _you_.
