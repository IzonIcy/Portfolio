...
image: '/static/images/accelerating/bg.webp'
---
...
**Accelerating** (_verb_): achieving a high number of consecutive net positive days to leverage the power of compounding for personal growth.
...
Solution is to take a precaution, and stay in shape, _bare minimum_.

Then, be very objective, if you can't ask a friend, if he's not objective, ask a random stranger: **what are my shortcomings?** Focus on those. In my case I was underweight by a lot and thought that _"that's how my metabolism is"_, which is, in fact, true - but that does not mean that you cannot do anything against that. Go on a calorie surplus, do weight lifting or calisthenics and you're good. You can do your own scenario depending on your situation. Reality is that nobody is perfect, but we can tend asymptotically towards greatness.
...
This could be different from person to person, but at least try to be _grateful for anything that you have_. You could always give a contra-example of what you have, so remember to be happy and aknowledge that you're priviliged in any way (small or very big).
